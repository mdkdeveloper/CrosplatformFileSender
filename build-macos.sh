...
echo "Running: ./gradlew :desktopApp:packageDmg --console=plain --info --stacktrace --no-daemon"

if [[ -x "$repo_root/gradlew" ]]; then
    "$repo_root/gradlew" :desktopApp:packageDmg --console=plain --info --stacktrace --no-daemon
else
    bash "$repo_root/gradlew" :desktopApp:packageDmg --console=plain --info --stacktrace --no-daemon
fi
